...
#2
select g.FullName, g.Email, r.RoomType, b.CheckInDate from bookings as b
...
order by b.CheckInDate asc limit 5;

#3
select r.RoomNumber, r.RoomType, g.GuestID from bookings as b
join guests as g on g.GuestID = b.GuestID
join rooms as r on r.RoomID = b.RoomID
...
#4
select g.FullName, g.Email, g.PhoneNumber from bookings as b
join guests as g on g.GuestID = b.GuestID
join rooms as r on r.RoomID = b.RoomID
where g.Gender = 'Nam' group by g.GuestID having count(b.BookingID) >=2;

#5
select g.FullName, g.PhoneNumber, r.RoomType from bookings as b
join guests as g on g.GuestID = b.GuestID
join rooms as r on r.RoomID = b.RoomID
